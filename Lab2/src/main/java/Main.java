...
public class Main {
    ...
    public static double midel(int [] array)
    {
        double midel=0;
        int schetchik=0;
    ...
    public static void minofarr(int [] array){
        int min=array[0];
        int schetchik=0;
        for (int i=0; i<array.length;i++){
            if(min>array[i]){
        ...
        System.out.println("Min="+min+"His number="+schetchik);
    }
    public static void MostnegXsmallpair(int [] array){
    ...
    public static int fiveelement(int [] array){
        int num=array[0];
        int kolvo=1;
        int schetchik=0;
        Arrays.sort(array);
    ...
    public static int summnechetpair(int[] array){
        int sum=0;
        for (int i=1; i<array.length;i++){
            if(array[i]%2==0){
                    sum += array[i];
    ...
    public static int SumSecondAndPositive(int [] array){
        int mostpositive=0;
        for (int i=0; i<array.length;i++){
    ...
    public static List even(int matrix[][]){
    ...
    public static List poslidovnist(int matrix [][]){
        List numbers = new ArrayList();
        int temp=0;
        int znak=1;
        for (int i = 0;i<matrix.length;i++) {
